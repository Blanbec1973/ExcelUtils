...
public class FusionTRX implements CommandService {
    ...
    public void execute(CommandArgs args) {
        FusionTRXArgs parsed = (FusionTRXArgs) args;
        String directoryToProcess = (parsed.directory().toString().isEmpty()) ? System.getProperty("user.dir")+"\\" : parsed.directory().toString();
        String pathFusion = parsed.outputPath().toString();
